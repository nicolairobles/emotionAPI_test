class EmotizeProcessor < VideosController
  ...
  def perform(video_id)
  	# Rails.logger.info outputs logs in Heroku env
    Rails.logger.info "Initiating background processing"
  	# SET UP ENV
    ...
    # ResultMailer	
    Rails.logger.info "Results ready email notification to be sent here"
